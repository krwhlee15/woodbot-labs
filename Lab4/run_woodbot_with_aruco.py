...
CAMERA_FILE_PATH = OUTPUT_PATH + 'Woodbot' + time_str() # this will be like: Model_current_data_time# e
...
aruco = o.add_robot(robot_def=WoodbotDef, robot=ArucoBot,
                    robot_args=dict(tracids=1, camera_id=0,),
...
o.run(SimConfig(max_duration=100, dt=0.1, realtime=True, start_time=0, run_speed=1))
